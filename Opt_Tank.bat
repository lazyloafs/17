...
rem ============================================================================
rem  Opt Tank — Deep optimize for survivability (regen/eHP, single phase)
rem  Patches PoB, queues tank optimize, launches Path of Building.
rem
...
echo Patching PoB and queueing tank optimize...
...
echo Click "Opt Tank" or wait for auto-run when the build loads.
echo.
